	...
	<body>
		...
		<div id="show-emplacement" class="content scaffold-show" role="main">
			...
			<ol class="property-list emplacement">
				...
				<g:if test="${emplacementInstance?.latitude}">
				<li class="fieldcontain">
					<span id="latitude-label" class="property-label"><g:message code="emplacement.latitude.label" default="Latitude" /></span>
					
						<span class="property-value" aria-labelledby="latitude-label"><g:fieldValue bean="${emplacementInstance}" field="latitude"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${emplacementInstance?.longitude}">
				<li class="fieldcontain">
					<span id="longitude-label" class="property-label"><g:message code="emplacement.longitude.label" default="Longitude" /></span>
					
						<span class="property-value" aria-labelledby="longitude-label"><g:fieldValue bean="${emplacementInstance}" field="longitude"/></span>
